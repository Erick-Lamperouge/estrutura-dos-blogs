(function(){
  ...
  function setActiveByIndex(i){
    ...
    sel.value = cards[idx].dataset.method;
    // rola o carrossel no mobile
    viewport.scrollTo({ left: cards[idx].offsetLeft - 12, behavior:'smooth' });
  }

  function indexOfActive(){
    return cards.findIndex(c=>c.classList.contains('is-active'));
  }
